...
public class PerformanceMeasure {
    ...
    private int numOfCities = 100;
    private int totalGenerations = 1000;
    private int x_lim = 20;
    private int y_lim = 20;
...
//    HamiltonCycle bestInstance = null;
    ...
    private InstancePopulation evolveInstance(InstancePopulation IP) {    // returns of population of 1.5x the original size
     ...
     */
    private void evalAndSetPerformanceDifference(InstancePopulation population, TSP_Solver A, TSP_Solver B, String measureType) {
//        InstancePopulation result = population.clone();
    ...
    private double compareAlgorithms(TSP_Solver A, TSP_Solver B, HamiltonCycle HC, String measureType) {   // compare 1-2   // type is either 'r' or 'p'
