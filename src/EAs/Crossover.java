...
public class Crossover {
    ...
    /**
     * RandomCrossover takes in two parents and generates the child by randomly
     * choosing the city of the same index from one of the parents.
     *
     * @param parent1
     * @param parent2
    ...
    /**
     * Transplant Crossover preserves the clusters of one of the parents in a
     * particular part of the map: either top left and bottom right, or top
